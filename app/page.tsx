...
export default function Home(){
 ...
 <a href="https://wa.me/000000000000" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="md:hidden fixed bottom-5 right-5 z-[60] w-14 h-14 rounded-full bg-emerald-500 flex items-center justify-center shadow-[0_0_25px_rgba(16,185,129,.5)]"><WhatsappIcon size={26} className="text-white"/></a>
